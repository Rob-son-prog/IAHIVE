  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100 flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <p className="mt-1 text-sm text-neutral-400">Use Google ou suas credenciais.</p>
...
>
  ...
  <svg
    ...
    className="h-5 w-5"
  >
    <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.9 29.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.9 6 29.7 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20c10 0 19-7.3 19-20 0-1.2-.1-2.3-.4-3.5z"/>
    <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 16.4 19 12 24 12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.9 6 29.7 4 24 4 16.1 4 9.2 8.5 6.3 14.7z"/>
    <path fill="#4CAF50" d="M24 44c5.1 0 9.9-1.9 13.5-5.2l-6.2-5.1C29.2 36 26.7 37 24 37c-5.2 0-9.6-3.1-11.4-7.6l-6.6 5.1C8.9 39.5 15.9 44 24 44z"/>
    <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.1-3.6 5.6-6.8 6.6l6.2 5.1C37.2 37.9 40 32.5 40 26c0-1.9-.2-3.7-.4-5.5z"/>
  </svg>
  ...
  <span>Continuar com Google</span>
        ...
        <p className="mt-4 text-sm text-neutral-400">
          Não tem conta?{" "}
          <a href="/register" className="text-neutral-200 underline underline-offset-4">Cadastre-se</a>
        </p>
      </div>
    </main>
  );
